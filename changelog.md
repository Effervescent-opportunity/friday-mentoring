...
1. Можно изменять данные пользователей и их права в БД, нужно, чтобы доступ к БД был только у "доверенных лиц"
2. Нет возможности изменить пароль, нет срока действия пароля
3. Названия ролей и пользователей захардкожены в коде
