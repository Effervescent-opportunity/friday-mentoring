...
- Выбран Docker-образ Kafka и Zookeeper от Confluentinc, потому что Confluent был создан теми же людьми, которые создали Kafka, почему бы не попробовать именно его
...
- Нет тестов на случай неуспешной авторизации для PreAuthorize - не создаются event'ы почему-то. Плюс возможны лишние параметры в конфигурации теста
