...
- Выделение интерфейса не было сделано, просто нет части теста в KafkaProducerTest для случая работающей Кафки, потому что не хочу множить сущности без большой необходимости, плюс 
тестовая реализация интерфейса мне видится нужной крайне редко, куда проще замокать всё или написать интеграционный тест
- Объединены исключения, которые ловятся в `KafkaProducer.kafkaIsActive()`, потому что поведение не изменится в случае того или иного исключения, плюс для облегчения тестирования
